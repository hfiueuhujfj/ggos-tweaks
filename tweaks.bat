...
cls
call :banner
echo         [1] GGOS Tweaks          [2] Optional GGOS Tweaks          [3] Troubleshooting          [4] placeholder
echo.
echo.
...
echo    [4] Disable Lanman Workstation   [9] Enable VPN and PPoE Connections     [14] Disable Gamebar   [19] GGOS Defaults
echo    [5] Enable Bluetooth             [10] Disable VPN and PPoE Connections   [15] Enable UAC
echo. 
echo    [B] Back
echo.
...
:nine
echo Enabling VPN and PPoE connections...
...
echo.
echo VPN and PPoE connections enabled. Please restart your computer.
...
:ten
echo Disabling VPN and PPoE connections
...
echo.
echo VPN and PPoE connections disabled. Please restart your computer.
echo.
pause
goto :main
...
reg add "HKLM\SYSTEM\CurrentControlSet\Services\RasPppoe" /v "Start" /t REG_DWORD /d "3" /f >nul 2>&1
